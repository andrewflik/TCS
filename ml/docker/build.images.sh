...
docker image rm andrewflik/lt-rest:1.0
...
docker build -t andrewflik/lt-base-ubuntu16:1.0 -f Dockerfile.ubuntu16.04.base .
docker build -t andrewflik/lt-rest:1.0 -f Dockerfile.rest .
